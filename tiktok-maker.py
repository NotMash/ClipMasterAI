...
final_video = create_tiktok_video(
    ...
    additional_clip_path = "C:\\Users\\ismai\\PycharmProjects\\TIKTOK-AUTOMATION\\downloaded_videos\\Ted.mp4",
    subtitles_text= "This is a TikTok video created using Python- ISMAIL!"
)
